...
this prevents issues when you start conky at startup
]]
...
if THEME == "monochrome dark" then
    ...
    color4 = 0xFF0000   -- fireground modifier: critical color
...
elseif THEME == "cyan light" then
    ...
    color3 = nil        -- fireground modifier: warning color
    color4 = nil        -- fireground modifier: critical color
